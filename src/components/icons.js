...
export function Icon({ d, size = 22, stroke = 'currentColor', sw = 1.8, fill = 'none', style }) {
    return (_jsx("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: fill, stroke: stroke, strokeWidth: sw, strokeLinecap: "round", strokeLinejoin: "round", style: style, children: d.map((p, i) => _jsx("path", { d: p }, i)) }));
}
export const icons = {
...
export function I({ name, size = 22, sw = 1.8, fill, style }) {
    return _jsx(Icon, { d: icons[name], size: size, sw: sw, fill: fill, style: style });
}
